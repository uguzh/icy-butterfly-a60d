...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/icy-butterfly-a60d)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/icy-butterfly-a60d
```

A live public deployment of this template is available at [https://icy-butterfly-a60d.templates.workers.dev](https://icy-butterfly-a60d.templates.workers.dev)
